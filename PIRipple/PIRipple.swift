...
public class Ripple {
    ...
    public class func run(_ view:UIView, locationInView:CGPoint, option:Ripple.Option) {
        run(view, locationInView: locationInView, option: option){}
    }
    
    public class func run(_ view:UIView, locationInView:CGPoint, option:Ripple.Option, then: @escaping ()->() ) {
        prePreform(view, point: locationInView, option: option, isLocationInView: true, then: then)
    }
    
    public class func run(_ view:UIView, absolutePosition:CGPoint, option:Ripple.Option) {
        run(view, absolutePosition: absolutePosition, option: option){}
    }
    
    public class func run(_ view:UIView, absolutePosition:CGPoint, option:Ripple.Option, then: @escaping ()->() ) {
    ...
    private class func prePreform(_ view: UIView, point: CGPoint, option: Ripple.Option, isLocationInView: Bool, then: @escaping ()->() ) {
    ...
    private class func perform(_ view:UIView, point:CGPoint, option: Ripple.Option, then: @escaping ()->() ) {
